...
''')
    ...
    st.data_editor(rfm_stats.set_index('RFM сегмент'), column_config={"test": st.column_config.ProgressColumn("Сумма донаций", help="Общая сумма донаций", format="%f руб.", min_value=0, max_value=rfm_stats.test.max())}, hide_index=True, height=980)
